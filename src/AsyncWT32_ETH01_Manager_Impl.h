/****************************************************************************************************************************
  AsyncWT32_ETH01_Manager_Impl.h
  ...
  ------- -----------  ---------- -----------
  1.0.0   K Hoang     09/12/2022 Initial coding for WT32_ETH01
 *****************************************************************************************************************************/

#pragma once

#ifndef AsyncWT32_ETH01_Manager_Impl_h
#define AsyncWT32_ETH01_Manager_Impl_h
...
/**
   ...
   @access public
*/
ESPAsync_EMParameter** AsyncWT32_ETH01_Manager::getParameters()
{
  return _params;
}
...
/**
   ...
   @access public
*/
int AsyncWT32_ETH01_Manager::getParametersCount()
{
  return _paramsCount;
}
...
char* AsyncWT32_ETH01_Manager::getRFC952_hostname(const char* iHostname)
{
...
AsyncWT32_ETH01_Manager::AsyncWT32_ETH01_Manager(AsyncWebServer * webserver, AsyncDNSServer *dnsserver,
...
AsyncWT32_ETH01_Manager::~AsyncWT32_ETH01_Manager()
{
#if USE_DYNAMIC_PARAMS
...
#if USE_DYNAMIC_PARAMS
  bool AsyncWT32_ETH01_Manager::addParameter(ESPAsync_EMParameter *p)
#else
  void AsyncWT32_ETH01_Manager::addParameter(ESPAsync_EMParameter *p)
#endif
{
#if USE_DYNAMIC_PARAMS
...
void AsyncWT32_ETH01_Manager::setupConfigPortal()
{
  ...
  server->on("/",         std::bind(&AsyncWT32_ETH01_Manager::handleRoot,        this,
                                    std::placeholders::_1)).setFilter(ON_AP_FILTER);
  server->on("/eth",     std::bind(&AsyncWT32_ETH01_Manager::handleETH,        this,
                                   std::placeholders::_1)).setFilter(ON_AP_FILTER);
  server->on("/ethsave", std::bind(&AsyncWT32_ETH01_Manager::handleETHSave,    this,
                                   std::placeholders::_1)).setFilter(ON_AP_FILTER);
  server->on("/close",    std::bind(&AsyncWT32_ETH01_Manager::handleServerClose, this,
                                    std::placeholders::_1)).setFilter(ON_AP_FILTER);
  server->on("/i",        std::bind(&AsyncWT32_ETH01_Manager::handleInfo,        this,
                                    std::placeholders::_1)).setFilter(ON_AP_FILTER);
  server->on("/r",        std::bind(&AsyncWT32_ETH01_Manager::handleReset,       this,
                                    std::placeholders::_1)).setFilter(ON_AP_FILTER);
  server->on("/state",    std::bind(&AsyncWT32_ETH01_Manager::handleState,       this,
                                    std::placeholders::_1)).setFilter(ON_AP_FILTER);
  //Microsoft captive portal. Maybe not needed. Might be handled by notFound handler.
  server->on("/fwlink",   std::bind(&AsyncWT32_ETH01_Manager::handleRoot,        this,
                                    std::placeholders::_1)).setFilter(ON_AP_FILTER);
  server->onNotFound (std::bind(&AsyncWT32_ETH01_Manager::handleNotFound,        this, std::placeholders::_1));
...
bool AsyncWT32_ETH01_Manager::startConfigPortal()
{
  connect = false;
...
void AsyncWT32_ETH01_Manager::setTimeout(const unsigned long& seconds)
{
...
void AsyncWT32_ETH01_Manager::setConfigPortalTimeout(const unsigned long& seconds)
{
...
void AsyncWT32_ETH01_Manager::setConnectTimeout(const unsigned long& seconds)
{
  _connectTimeout = seconds * 1000;
}

void AsyncWT32_ETH01_Manager::setDebugOutput(bool debug)
{
  _debug = debug;
}
...
void AsyncWT32_ETH01_Manager::setBreakAfterConfig(bool shouldBreak)
{
...
void AsyncWT32_ETH01_Manager::reportStatus(String& page)
{
...
void AsyncWT32_ETH01_Manager::setSTAStaticIPConfig(const IPAddress& ip, const IPAddress& gw, const IPAddress& sn)
{
...
void AsyncWT32_ETH01_Manager::setSTAStaticIPConfig(const ETH_STA_IPConfig& EM_STA_IPconfig)
{
  LOGINFO(F("setSTAStaticIPConfig"));
...
void AsyncWT32_ETH01_Manager::getSTAStaticIPConfig(ETH_STA_IPConfig& EM_STA_IPconfig)
{
...
void AsyncWT32_ETH01_Manager::handleRoot(AsyncWebServerRequest *request)
{
...
void AsyncWT32_ETH01_Manager::handleETH(AsyncWebServerRequest *request)
{
...
void AsyncWT32_ETH01_Manager::handleETHSave(AsyncWebServerRequest *request)
{
  LOGDEBUG(F("ETH save"));
...
void AsyncWT32_ETH01_Manager::handleServerClose(AsyncWebServerRequest *request)
{
...
void AsyncWT32_ETH01_Manager::handleInfo(AsyncWebServerRequest *request)
{
  LOGDEBUG(F("Info"));
  ...
  page += F("<p/>More information about AsyncWT32_ETH01_Manager at");
  page += F("<p/><a href=\"https://github.com/khoih-prog/AsyncWT32_ETH01_Manager\">https://github.com/khoih-prog/AsyncWT32_ETH01_Manager</a>");
  page += FPSTR(EM_HTTP_END);
...
void AsyncWT32_ETH01_Manager::handleState(AsyncWebServerRequest *request)
{
...
void AsyncWT32_ETH01_Manager::handleReset(AsyncWebServerRequest *request)
{
  LOGDEBUG(F("Reset"));
...
void AsyncWT32_ETH01_Manager::handleNotFound(AsyncWebServerRequest *request)
{
  if (captivePortal(request))
  {
...
*/
bool AsyncWT32_ETH01_Manager::captivePortal(AsyncWebServerRequest *request)
{
...
void AsyncWT32_ETH01_Manager::setSaveConfigCallback(void(*func)())
{
  _savecallback = func;
}
...
void AsyncWT32_ETH01_Manager::setCustomHeadElement(const char* element)
{
...
// Is this an IP?
bool AsyncWT32_ETH01_Manager::isIp(const String& str)
{
...
// IP to String
String AsyncWT32_ETH01_Manager::toStringIp(const IPAddress& ip)
{
  String res = "";
...
#endif    // AsyncWT32_ETH01_Manager_Impl_h
