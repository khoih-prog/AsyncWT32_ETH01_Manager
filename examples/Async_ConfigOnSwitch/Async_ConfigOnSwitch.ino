...
void setup()
{
  ...
  AsyncWT32_ETH01_Manager AsyncWT32_ETH01_manager(&webServer, NULL, "AsyncConfigOnSwitch");
#else
  AsyncDNSServer dnsServer;

  AsyncWT32_ETH01_Manager AsyncWT32_ETH01_manager(&webServer, &dnsServer, "AsyncConfigOnSwitch");
#endif
