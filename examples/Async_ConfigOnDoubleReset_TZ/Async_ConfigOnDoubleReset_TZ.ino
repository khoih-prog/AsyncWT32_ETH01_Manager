...
#if !( defined(ESP32) )
  #error This code is intended to run on the WT32_ETH01 platform! Please check your Tools->Board setting.
#endif
...
void setup()
{
  ...
  AsyncWT32_ETH01_Manager AsyncWT32_ETH01_manager(&webServer, NULL, "AsyncConfigOnDoubleReset");
#else
  AsyncDNSServer dnsServer;

  AsyncWT32_ETH01_Manager AsyncWT32_ETH01_manager(&webServer, &dnsServer, "AsyncConfigOnDoubleReset");
#endif
